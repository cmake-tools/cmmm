...
macro(CMMM_INCLUDE_MODULE)
  ...
  while(NOT EXISTS "${ARG_DESTINATION}" OR "${CMakeMMSHA256}" STREQUAL "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855" OR CMMM_ALWAYS_DOWNLOAD)
    if(${CMMM_RETRIES_DONE} STREQUAL "0")
      message(STATUS "${Esc}${CMMM_DEFAULT_COLOR}[ CMMM ] Downloading ${ARG_URL} to ${ARG_DESTINATION}${Esc}${CMMM_RESET_COLOR}")
    else()
      message(STATUS "${Esc}${CMMM_INFO_COLOR}[ CMMM ] Retry downloading ${ARG_URL} (${CMMM_RETRIES_DONE}/${CMMM_RETRIES}).${Esc}${CMMM_RESET_COLOR}")
    endif()
