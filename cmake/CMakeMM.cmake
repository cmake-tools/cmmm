...
function(cmmm_changes CHANGELOG_VERSION)
  if(${CMMM_VERSION} VERSION_LESS ${CHANGELOG_VERSION})
    message("-- Changes in ${CHANGELOG_VERSION} :")
...
function(print_changelog)
  message("${CMMM_INFO_COLOR}## [CMMM] Using CMakeMM version ${CMMM_VERSION}. The latest version is ${CMMM_LATEST_VERSION}. ##${CMMM_RESET_COLOR}")
  message("${CMMM_INFO_COLOR}## Changes since ${CMMM_VERSION} include the following : ##${CMMM_RESET_COLOR}")
  changelog()
  message("${CMMM_INFO_COLOR}## To update, simply change the value of VERSION in cmmm function. ##${CMMM_RESET_COLOR}")
  message("${CMMM_INFO_COLOR}## You can disable these messages by setting NO_CHANGELOG in cmmm function. ##${CMMM_RESET_COLOR}")
endfunction()
  ...
  if(NOT ${CMMM_NO_CHANGELOG} AND NOT ${CMMM_VERSION} STREQUAL "latest")
    ...
    while(NOT CMAKEMM_INITIALIZED_${CMMM_TAG} OR NOT EXISTS "${CMMM_CHANGELOG_FILE}" OR "${CMakeMMSHA256}" STREQUAL "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855")
      ...
      if(${CMMM_RETRIES_DONE} STREQUAL "0")
        message("${CMMM_COLOR}-- [CMMM] Downloading Changelog.cmake to ${CMMM_CHANGELOG_FILE} --${CMMM_RESET_COLOR}")
      else()
        message("${CMMM_WARN_COLOR}-- [CMMM] Retrying (${CMMM_RETRIES_DONE}/${CMMM_RETRIES}) --${CMMM_RESET_COLOR}")
      endif()
      ...
      if(${CMAKECM_CODE})
        message("${CMMM_ERROR_COLOR}** [CMMM] Error downloading Changelog.cmake : ${CMAKECM_MESSAGE} (${CMAKECM_CODE}). **${CMMM_RESET_COLOR}")
      else()
        file(SHA256 "${CMMM_CHANGELOG_FILE}" CMakeMMSHA256)
        if(${CMakeMMSHA256} STREQUAL "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855")
          ...
          message("${CMMM_ERROR_COLOR}** [CMMM] Error downloading Changelog.cmake : Empty file. **${CMMM_RESET_COLOR}")
        else()
          print_changelog()
        endif()
      endif()
      if("${CMMM_RETRIES_DONE}" STREQUAL "${CMMM_RETRIES}")
        message("${CMMM_RESET_COLOR}** [CMMM] Error downloading Changelog.cmake. Skipping ! **${CMMM_RESET_COLOR}")
        break()
      endif()
