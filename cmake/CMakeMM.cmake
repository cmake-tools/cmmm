...
function(cmmm_modules_list)
  ...
  elseif(DEFINED CMMM_GITLAB_REPOSITORY)
    set(CMMM_URL "https://gitlab.com/${CMMM_GITLAB_REPOSITORY}/-/raw/${CMMM_GIT_TAG}/${CMMM_FILEPATH}")
  elseif(DEFINED CMMM_BITBUCKET_REPOSITORY)
    set(CMMM_URL "https://bitbucket.org/${CMMM_BITBUCKET_REPOSITORY}/raw/${CMMM_GIT_TAG}/${CMMM_FILEPATH}")
  endif()

  string(FIND ${CMMM_URL} "/" CMMM_FOUND REVERSE)
  math(EXPR CMMM_FOUND "${CMMM_FOUND}+1")
  string(SUBSTRING ${CMMM_URL} "${CMMM_FOUND}" "-1" CMMM_FILE)
  ...
  if(DEFINED CMMM_TLS_CAINFO AND NOT "${CMMM_TLS_CAINFO}" STREQUAL "")
  ...
  if(DEFINED "CMAKEMM_INITIALIZED_${CMMM_DESTINATION}_${CMMM_FILE}" AND NOT "${CMAKEMM_INITIALIZED_${CMMM_DESTINATION}_${CMMM_FILE}}" STREQUAL "${CMMM_URL}")
    message(STATUS
            "${Esc}${CMMM_FATAL_ERROR_COLOR}[ CMMM ] It already exists ${CMMM_DESTINATION}/${CMMM_FILE} downloaded from ${CMAKEMM_INITIALIZED_${CMMM_DESTINATION}_${CMMM_FILE}}.
            Impossible to download the one from ${CMMM_URL}.${Esc}${CMMM_RESET_COLOR}")
    message(FATAL_ERROR
            "It already exists ${CMMM_DESTINATION}/${CMMM_FILE} downloaded from ${CMAKEMM_INITIALIZED_${CMMM_DESTINATION}_${CMMM_FILE}}.
            Impossible to download the one from ${CMMM_URL}.")
  endif()
  ...
  while(NOT DEFINED "CMAKEMM_INITIALIZED_${CMMM_DESTINATION}_${CMMM_FILE}" OR NOT EXISTS "${CMMM_DESTINATION}/${CMMM_FILE}" OR "${CMakeMMSHA256}" STREQUAL "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855" OR CMMM_ALWAYS_DOWNLOAD)
    if(${CMMM_RETRIES_DONE} STREQUAL "0")
      message(STATUS "${Esc}${CMMM_DEFAULT_COLOR}[ CMMM ] Downloading ${CMMM_URL} to ${CMMM_DESTINATION}/${CMMM_FILE}${Esc}${CMMM_RESET_COLOR}")
    else()
      message(STATUS "${Esc}${CMMM_INFO_COLOR}[ CMMM ] Retry downloading ${CMMM_FILE} (${CMMM_RETRIES_DONE}/${CMMM_RETRIES}).${Esc}${CMMM_RESET_COLOR}")
    endif()

    file(
      DOWNLOAD "${CMMM_URL}" "${CMMM_DESTINATION}/${CMMM_FILE}" LOG CMMM_LOG STATUS CMAKECM_STATUS
