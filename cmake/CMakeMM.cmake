...
function(cmmm_define_module NAME)
  ...
  if(DEFINED ARG_REMOTE)
    list(APPEND CMMM_COMMAND "${CMMM_COMMAND}" "URL" "[[${ARG_REMOTE}]]")
  else()
    list(APPEND CMMM_COMMAND "${CMMM_COMMAND}" "URL" "[[${CMMM_URL}/${ARG_LOCAL}]]")
  endif()
  set(COMMAND "")
...
macro(CMMM_INCLUDE_MODULE)
  ...
  set(CMMM_COMMAND "")
  list(PROPERTIES "CMMM_INACTIVITY_TIMEOUT" "CMMM_TIMEOUT" "CMMM_TLS_VERIFY" "CMMM_TLS_CAINFO" "CMMM_NETRC" "CMMM_NETRC_FILE")
