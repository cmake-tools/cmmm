...
function(cmmm_parse_single_arg arg outArgs)
  ...
  if("${arg}" MATCHES "^([a-zA-Z]+):(.+)$")
    ...
    elseif(scheme STREQUAL "bb")
      ...
      set(packageType "git")
    elseif(scheme STREQUAL "gt")
      set(out "GITTEA_REPOSITORY;${url}")
      set(packageType "git")
    elseif(scheme STREQUAL "cb")
      set(out "CODEBERG_REPOSITORY;${url}")
      set(packageType "git")
    else()
      # Fall back to a URL
      set(out "URL;${arg}")
...
function(cmmm_modules_list)
  ...
  unset(CMMM_URL)
  cmake_parse_arguments(CMMM "" "URL;GITHUB_REPOSITORY;GITLAB_REPOSITORY;BITBUCKET_REPOSITORY;CODEBERG_REPOSITORY;GITTEA_REPOSITORY;GIT_TAG" "" "${CMMM_URL_RETURN}")
  ...
  elseif(DEFINED CMMM_CODEBERG_REPOSITORY)
    set(CMMM_URL "https://codeberg.org/${CMMM_BITBUCKET_REPOSITORY}/raw/${CMMM_GIT_TAG}")
  elseif(DEFINED CMMM_GITTEA_REPOSITORY)
    set(CMMM_URL "https://gitea.com/${CMMM_BITBUCKET_REPOSITORY}/raw/${CMMM_GIT_TAG}")
  endif()
...
function(cmmm_define_module NAME)
  ...
  if(DEFINED ARG_REMOTE)
    ...
    elseif(DEFINED CMMM_CODEBERG_REPOSITORY)
      set(CMMM_URL "https://codeberg.org/${CMMM_BITBUCKET_REPOSITORY}/raw/${CMMM_GIT_TAG}/${ARG_FILEPATH}")
    elseif(DEFINED CMMM_GITTEA_REPOSITORY)
      set(CMMM_URL "https://gitea.com/${CMMM_BITBUCKET_REPOSITORY}/raw/${CMMM_GIT_TAG}/${ARG_FILEPATH}")
    endif()
