...
function(cmmm_print_changelog)
  message(STATUS "${Esc}${CMMM_INFO_COLOR} [ CMMM ] Using CMakeMM version ${CMMM_VERSION}. The latest version is ${CMMM_LATEST_VERSION}.${Esc}${CMMM_RESET_COLOR}")
  message(STATUS "${Esc}${CMMM_INFO_COLOR} Changes since ${CMMM_VERSION} include the following :${Esc}${CMMM_RESET_COLOR}")
  cmmm_changelog()
  message(STATUS "${Esc}${CMMM_INFO_COLOR} To update, simply change the value of VERSION in cmmm function.${Esc}${CMMM_RESET_COLOR}")
  message(STATUS "${Esc}${CMMM_INFO_COLOR} You can disable these messages by setting NO_CHANGELOG in cmmm function.${Esc}${CMMM_RESET_COLOR}")
endfunction()
