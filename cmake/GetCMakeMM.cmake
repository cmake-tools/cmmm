...
function(cmmm)
  ...
  if(NOT "${CMMM_FETCHED_TAG}" STREQUAL "${CMMM_TAG}")
    ...
    configure_file("${cmmm_SOURCE_DIR}/cmake/CMakeMM.cmake" "${CMMM_DESTINATION}/CMakeMM-${CMMM_FETCHED_TAG}.cmake" COPYONLY)
    include("${CMMM_DESTINATION}/CMakeMM-${CMMM_FETCHED_TAG}.cmake")
  endif()
  cmmm_entry(${ARGN})
  unlock()
