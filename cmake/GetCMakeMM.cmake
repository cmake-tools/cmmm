...
function(cmmm)
  ...
  if(DEFINED ENV{CMAKE_COLOR_DIAGNOSTICS} OR DEFINED CACHE{CMAKE_COLOR_DIAGNOSTICS} OR DEFINED CMAKE_COLOR_DIAGNOSTICS)
    set(CMMM_NO_COLOR FALSE)
  endif()
  if(WIN32 OR DEFINED ENV{CLION_IDE} OR DEFINED ENV{DevEnvDir} OR DEFINED ENV{workspaceRoot} OR DEFINED CMMM_NO_COLOR OR DEFINED ENV{CMMM_NO_COLOR} OR DEFINED CACHE{CMMM_NO_COLOR})
  ...
  if(NOT CMAKEMM_INITIALIZED_${CMMM_TAG} OR NOT EXISTS "${CMMM_DESTINATION}/CMakeMM-${CMMM_TAG}.cmake")
    ...
    file(
      DOWNLOAD "${CMMM_URL}/${CMMM_TAG}/CMakeMM.cmake1" "${CMMM_DESTINATION}/CMakeMM-${CMMM_TAG}.cmake"
