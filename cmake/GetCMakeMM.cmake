...
function(cmmm)
  ...
  if(DEFINED CMMM_INACTIVITY_TIMEOUT)
    set(CMMM_COMMAND "INACTIVITY_TIMEOUT;${CMMM_INACTIVITY_TIMEOUT}")
  endif()

  if(DEFINED CMMM_TIMEOUT)
    set(CMMM_COMMAND "${CMMM_COMMAND};TIMEOUT;${CMMM_TIMEOUT}")
  endif()
  ...
  if(${CMMM_TLS_VERIFY} STREQUAL "ON" OR ${CMMM_TLS_VERIFY} STREQUAL "OFF")
    set(CMMM_COMMAND "${CMMM_COMMAND};TLS_VERIFY;${CMMM_TLS_VERIFY}")
  else()
  ...
  if(DEFINED CMMM_TLS_CAINFO)
    set(CMMM_COMMAND "${CMMM_COMMAND};TLS_CAINFO;${CMMM_TLS_CAINFO}")
  endif()
  ...
  cmmm_entry("DESTINATION;${CMMM_DESTINATION};TAG;${CMMM_TAG};RETRIES;${CMMM_RETRIES};${ARGN}")
  unlock()
