...
function(cmmm)
  ...
  if(WIN32 OR DEFINED ENV{CLION_IDE} OR DEFINED ENV{DevEnvDir} OR DEFINED ENV{workspaceRoot})
    ...
    string(ASCII 27 Esc)
    set(CMMM_COLOR "${Esc}[1;35m")
    set(CMMM_ERROR_COLOR "${Esc}[1;31m")
    set(CMMM_WARN_COLOR "${Esc}[1;33m")
    set(CMMM_INFO_COLOR "${Esc}[1;32m")
    set(CMMM_RESET_COLOR "${Esc}[0m")
  endif()
  ...
  while(NOT CMAKEMM_INITIALIZED_${CMMM_TAG} OR NOT EXISTS "${CMMM_DESTINATION}/CMakeMM-${CMMM_TAG}.cmake" OR "${CMakeMMSHA256}" STREQUAL "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855")
    ...
    if(${CMMM_RETRIES_DONE} STREQUAL "0")
      message("${CMMM_COLOR}-- [CMMM] Downloading CMakeMM.cmake@${CMMM_VERSION} (${CMMM_TAG}) to ${CMMM_DESTINATION}/CMakeMM-${CMMM_TAG}.cmake --${CMMM_RESET_COLOR}")
    else()
    ...
    if(${CMAKECM_CODE})
      message("${CMMM_ERROR_COLOR}** [CMMM] Error downloading CMakeMM.cmake : ${CMAKECM_MESSAGE} (${CMAKECM_CODE}). **${CMMM_RESET_COLOR}")
    else()
      file(SHA256 "${CMMM_DESTINATION}/CMakeMM-${CMMM_TAG}.cmake" CMakeMMSHA256)
      if(${CMakeMMSHA256} STREQUAL "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855")
        ...
        message("${CMMM_ERROR_COLOR}** [CMMM] Error downloading CMakeMM.cmake : Empty file. **${CMMM_RESET_COLOR}")
      else()
        break()
      endif()
    endif()
    if("${CMMM_RETRIES_DONE}" STREQUAL "${CMMM_RETRIES}")
      unlock()
      message(FATAL_ERROR "!! [CMMM] Error downloading CMakeMM.cmake !!")
    endif()
