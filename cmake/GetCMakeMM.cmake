...
function(cmmm)
  ...
  if(${CMMM_TLS_VERIFY} STREQUAL "ON" OR ${CMMM_TLS_VERIFY} STREQUAL "OFF")
    ...
    fatal_error("!! [CMMM] TLS_VERIFY must have value ON or OFF. !!")
  endif()
  ...
  while(NOT CMAKEMM_INITIALIZED_${CMMM_TAG} OR NOT EXISTS "${CMMM_DESTINATION}/CMakeMM-${CMMM_TAG}.cmake" OR "${CMakeMMSHA256}" STREQUAL "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855")
    ...
    if(${CMMM_RETRIES_DONE} STREQUAL "0")
      ...
      if(CMMM_NO_COLOR)
        message("-- [CMMM] Retrying (${CMMM_RETRIES_DONE}/${CMMM_RETRIES}) --")
      else()
        message("${Esc}[1;35m-- [CMMM] Retrying (${CMMM_RETRIES_DONE}/${CMMM_RETRIES}) --${Esc}[m")
      endif()
    endif()

    file(
      DOWNLOAD "${CMMM_URL}/${CMMM_TAG}/CMakeMM1.cmake" "${CMMM_DESTINATION}/CMakeMM-${CMMM_TAG}.cmake"
    ...
    if(${CMAKECM_CODE})
      if(CMMM_NO_COLOR)
        message("** [CMMM] Error downloading CMakeMM.cmake : ${CMAKECM_MESSAGE} (${CMAKECM_CODE}). **")
      else()
        message("${Esc}[1;33m** [CMMM] Error downloading CMakeMM.cmake : ${CMAKECM_MESSAGE} (${CMAKECM_CODE}). **${Esc}[m")
      endif()
    else()
      file(SHA256 "${CMMM_DESTINATION}/CMakeMM-${CMMM_TAG}.cmake" CMakeMMSHA256)
      if(${CMakeMMSHA256} STREQUAL "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855")
        ...
        if(CMMM_NO_COLOR)
          message("** [CMMM] Error downloading CMakeMM.cmake : Empty file. **")
        else()
          message("${Esc}[1;33m** [CMMM] Error downloading CMakeMM.cmake : Empty file. **${Esc}[m")
        endif()
      else()
        break()
      endif()
    ...
    if("${CMMM_RETRIES_DONE}" STREQUAL "${CMMM_RETRIES}")
      unlock()
      fatal_error("!! [CMMM] Error downloading CMakeMM.cmake !!")
    endif()
